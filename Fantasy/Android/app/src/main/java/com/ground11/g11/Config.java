...
public class Config {
    ...
    public static String BASEURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/myrest/user/";

    public static String Authentication = "";

    public static String IMAGEBASEURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/uploads/";
    public static String ProfileIMAGEBASEURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/uploads/user/";
    //public static String TEAMFLAGIMAGE = IMAGEBASEURL+"team_image/";
    //http://cricketmanager.in/myrest/user/contest_list
    ...
    public static String TERMSANDCONDITIONSURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/website/termsandconditions";
    public static String FANTASYPOINTSYSTEMURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/website/pointsystem";
    public static String HOWTOPLAYURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/website/how_to_play";
    public static String ABOUTUSURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/website/aboutUs";
    public static String HELPDESKURL = "http://mybytecode.com/demo/fantasy/demo2/dream11/website/contactus";
