...
import static com.ground11.g11.Config.MYLIVELEADERBOARD;
import static com.ground11.g11.Config.MYLIVELEADERBOARDTEAM;
import static com.ground11.g11.Config.WINNINGINFOLIST;
import static com.ground11.g11.Constants.MYLIVELEADERBORADTEAMTYPE;
import static com.ground11.g11.Constants.MYLIVELEADERBORADTYPE;
import static com.ground11.g11.Constants.WINNINGINFOLISTTYPE;
...
public class MyResultContestDetailsActivity extends AppCompatActivity implements ResponseManager {
    ...
    TextView tv_TotalPrice,tv_EntryFees,tv_WinnersCount,tv_TotalJoinedTeamCount,
            tv_TeamOneScore,tv_TeamTwoScore, tv_TeamOneOver,tv_TeamTwoOver,tv_MatchResult,tv_TeamOneName,tv_TeamTwoName;
    String UserTeamId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_ContestTeamsName.setText(MyJoinedResultContestListActivity.IntenTeamsName);
        tv_ContestTimer.setText(MyJoinedResultContestListActivity.IntentTime);

        responseManager = this;
        apiRequestManager = new APIRequestManager(activity);


        Rv_MyResultLeaderboard.setHasFixedSize(true);
        Rv_MyResultLeaderboard.setNestedScrollingEnabled(false);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(activity);
        Rv_MyResultLeaderboard.setLayoutManager(mLayoutManager);
        Rv_MyResultLeaderboard.setItemAnimator(new DefaultItemAnimator());

        callLeaderboardList(true);

        Validations.CountDownTimer(MyJoinedResultContestListActivity.IntentTime,tv_ContestTimer);

        tv_ContestTimer.setText("Completed");
         tv_TeamOneName.setText(MyJoinedResultContestListActivity.IntentTeamOneName);
        tv_TeamTwoName.setText(MyJoinedResultContestListActivity.IntentTeamTwoName);
    ...
    public void initViews(){
        Rv_MyResultLeaderboard =  findViewById(R.id.Rv_MyResultLeaderboard);
    ...
    public void getResult(Context mContext, String type, String message, JSONObject result) {
        ...
        if (type.equals(WINNINGINFOLISTTYPE)){
            ...
            try {
                ...
                tv_MatchResult.setText(match_status_note);
                ...
                Rv_MyResultLeaderboard.setAdapter(adapterLeaderboard);
    ...
    public class AdapterLeaderboard extends RecyclerView.Adapter<AdapterLeaderboard.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            TextView tv_LeaderboardPlayerTeamName,tv_LeaderboardPlayerRank,tv_LeaderboardPlayerPoints
                    ,tv_LeaderboardPlayerWinningAmount;
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            if (ApiUserId.equals(sessionManager.getUser(activity).getUser_id())){
                ...
                holder.tv_LeaderboardPlayerWinningAmount.setTextColor(Color.parseColor("#1e1e1e"));
