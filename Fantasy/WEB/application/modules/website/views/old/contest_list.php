...
@media screen and (min-width: 400px) {
  ...
  .matchListContainer_ca5d2 {
    ...
    max-width: 100%!important;
    z-index: 3;
    animation: contest-footer-animate-in 300ms cubic-bezier(0, 0, 0, 1);
	}
...
@media screen and (min-width: 1200px) {
  ...
  .bottom-nav {
   ...
   <body>
                     ...
                     <div>
                           ...
                           <div class="headerContainer_199c8 headerFixed_38df7">
                              <div class="row-1 headerRow_c14ad">
                                 <div class="headerLeft_36c4e">
                                    <a class="btn btn--icon" href="<?php echo site_url('website/leagues'); ?>">
                                       <div class="align-center"><i class="material-icons">arrow_back</i></div>
                                    </a>
                                    <div class="js--match-header-home-btn"><a class="btn btn--icon" href="<?php echo site_url('website/leagues'); ?>"><i class="material-icons">home</i></a></div>
                                 </div>
                                 <div class="headerCenter_4d6f0">
                                    <div class="headerTitle_fd62d">Contests</div>
                                 </div>
                                 <div class="headerRight_ba2d2">
                                    <!-- <button class="btn btn--icon">
                                       <div class="align-center"><i class="material-icons">account_balance_wallet</i></div>
                                    </button> -->
                                 </div>
                              </div>
                              <div class="info-bar infobar_0dc07">
                                 <div class="infobarContent_628aa">
                                    <div class="infobarContentRow_7ae93">
                                       <div class="js--match-header-title infobarContentLeft_04a34"><?php echo $match_details['title'] ?></div>
                                       <div class="infobarContentCenter_5f791">
                                          <div class="timer_1aa54">
                                             ...
                                             <span class="timeRemaining_96d65">
                                                <?php if($match_details['match_status'] =="Fixture"){?>
                                                	<div class="timer_defb2" id="demo"></div>
                                                <?php } else if ($match_details['match_status'] =="Live") {
                                                	?>
                                                	<div class="timer_defb2">In Progress</div>
                                                	<?php 
                                                } else {
                                                	?>
                        ...
                        <div>
                           <div class="contestsHeader_16599">
                              ...
                              <div class="contestCountInfo_cc447"><?php echo count($contest); ?> contests available</div>
                           </div>
                           <?php
                            foreach($contest as $con){ ?>
                           <div>
                              <div class="segmentHeaderContainer_54896">
                                 <a class="row_404ce">
                                    <div>
                                       <div class="">
                                          <div class="headerTitle_ba6eb"><?php echo $con['contest_name']; ?></div>
                                          <div class="headerText_d7966"><?php echo $con['contest_tag']; ?></div>
                                       </div>
                                    </div>
                                 </a>
                              </div>
                              <a class="js--contest-card contestCardWrapper_c83dd" href="<?php echo base_url('website/contest_leaderboard/'.$con['contest_id']); ?>">
                                 <div class="contestSpecMoneyInfo_20124">
                                    ...
                                    <div class="contestSpecRow_01429">
                                       <div class="prizePool_565d2"><span><span class="d11-icon">Rs</span><span class="currency-amount"><?php echo $con['prize_pool']; ?></span></span></div>
                                       <div>
                                          <div style="display: flex; align-items: center;">
                                             <div class="js--contest-card-join-btn"><button class="new-button flatGreenButton_fb7a7"><span><span class="d11-icon">Rs</span><span class="currency-amount"><?php echo $con['entry']; ?></span></span></button></div>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <?php $free_space = $con['total_team']/($con['total_team']-$con['join_team'])*100; ?>
                                 <div class="contestProgressBarContainer_0efc1">
                                    <div class="contestProgressBar_eba45">
                                       <div class="contestProgressInner_ead13" style="width: <?php echo $free_space; ?>%;"></div>
                                    </div>
                                 </div>
                                 <div class="spotsContainer_9c427">
                                    <div class="contestSpecRow_01429">
                                       <div class="spotLefts_8d583 contestFilling_14509"><?php echo $con['total_team']-$con['join_team']; ?> spots left</div>
                                       <div class="totalSpots_b62ba"><?php echo $con['total_team']; ?> spots</div>
                                    </div>
                                 </div>
                           ...
                           <?php if($count > 20) {?>
                           <div>
                              <div class="allContestsButtonSegment_d9602">
                                 <div class="allContestsButtonSegmentHeader_a44f9">Couldn't find the contest you were looking for?</div>
                                 <a href="#" class="moreLink_570df">See all <?php echo $count; ?> contests</a>
                              </div>
                           </div>
                       <?php } ?>
                           <div class="contest-code-dialog"></div>
                        </div>
                        <?php if($match_details['match_status'] =="Fixture" ){?>
                        	<div class="contest-footer container_607ce">
                           <div class="innerContainer_b8f9b">
                              <div class="button-group">
                              	<?php if($team_count >0 ){?>
                              		<a class="btn btn--flat btn--bordered btn--bordered--white text-color--white" href="<?php echo site_url('website/teamDetails?match='.$match_details['match_id']) ?>">
                                    <div>My Teams (<?php echo $team_count; ?>)</div>
                                 </a>
                              	<?php }else{?>
                              		<a class="btn btn--flat btn--bordered btn--bordered--white text-color--white" href="<?php echo site_url('website/create_team?match='.$match_details['match_id']) ?>">
                                    <div>Create Team</div>
                                 </a>
                              	<?php } ?>
                                 
                                 <!-- <a class="btn btn--flat btn--background--white" href="#">
      ...
      <script>
      countdown('demo',"<?php echo $match_details['match_date_time'] ?>");
