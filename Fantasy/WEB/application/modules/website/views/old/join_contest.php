            ...
            <div class="row-1 headerRow_c14ad">
              <!-- <div class="headerLeft_36c4e">
                ...
                <div class="headerCenter_4d6f0">
                  <div class="headerTitle_fd62d">Join Match</div>
              </div>
              <!-- <div class="headerRight_ba2d2">
                <button class="btn btn--icon">
                  <div class="align-center"><i class="material-icons">account_balance_wallet</i>
                  </div>
                </button>
              </div> -->
            </div>
            <!-- <div class="info-bar infobar_0dc07">
              <div class="infobarContent_628aa">
                <div class="infobarContentRow_7ae93">
                  <div class="js--match-header-title infobarContentLeft_04a34">title </div>
                  <div class="infobarContentCenter_5f791"><div class="timer_1aa54">
                    ...
                    <span class="timeRemaining_96d65">
                      <div class="timer_defb2">18h 54m 01s</div>
                    </span>
                  </div>
                </div>
          ...
          <div class="scroll">
            <div class="my-teams__body">
              <div class="my-teams__title"></div>              
                ...
                <div class="my-teams__team">
                  ...
                  <div>
                    <div class="my-teams__bottom-section bottomSection_d41f9">
                      <div class="my-teams__role-entity"><div>
                        <div class="my-teams__role-entity__title my-teams__role-entity--even">Unutilized Balance + Winning</div>
                        <div class="my-teams__role-entity__player-name"><?php echo $total_amount; ?> Rs</div>
                      </div>
                      </div>
                      <div class="my-teams__role-entity">
                        <div>
                          <div class="my-teams__role-entity__title my-teams__role-entity--odd">Cash Bonus 10% of entry fees</div>
                          <div class="my-teams__role-entity__player-name"><?php echo $bonus; ?> Rs</div>
                        </div>
                      </div>
                  ...
                  <div>
                    <div class="my-teams__bottom-section bottomSection_d41f9">
                      <div class="my-teams__role-entity"><div>
                        <div class="my-teams__role-entity__title my-teams__role-entity--even">Payable Amount</div>
                        <div class="my-teams__role-entity__player-name"><?php echo $contest_price['entry']  - $bonus ?> Rs</div>
                      </div>
                      </div>
              ...
              <div class="my-teams__footer footer_d9dd6">
              	<form method="post" action="<?php echo base_url('website/join_contest_by_user'); ?>">
              		<input type="hidden" name="contest_id" value="<?php echo $contest_price['contest_id']; ?>">
              		<input type="hidden" name="match_id" value="<?php echo $contest_price['match_id']; ?>">
              		<input type="hidden" name="contest_amount" value="<?php echo $contest_price['entry']  - $bonus ?>">
              		<input type="hidden" name="my_team_id" value="<?php echo $this->uri->segment('3'); ?>">
              		<input class="btn btn--raised btn--white" type="submit" value="Join">
