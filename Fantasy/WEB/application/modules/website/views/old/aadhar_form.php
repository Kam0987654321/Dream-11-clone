...
<body cz-shortcut-listen="true" class="">
         ...
         <div class="lazy-container-my-profile">
            ...
            <div class="lazy-my-profile">
               ...
               <div class="my-profile">
                  ...
                  <div>
                     ...
                     <div class="app-toolbar appToolbar_1ea26">
                        ...
                        <div class="js--app-header header_fc30e">
                           ...
                           <div class="toolbar-title">UPLOAD AADHAR</div>
                  ...
                  <form method="post" enctype="multipart/form-data" action="<?php echo base_url('website/update_aadhar_information');?>">

                  <div class="my-profile__container">
                     <div>
                        <div class="form-field padding_b8f9b formField_4712e">

                           <div class="form-field-label">Aadhar Name</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input name="aadhar_card_name" class="input-field" value="<?php echo $user_info['name']; ?>" placeholder="Full Name" maxlength="524288"></div>
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input name="aadhar_number" class="input-field" value="<?php echo $user_info['name']; ?>" placeholder="Aadhar Number" maxlength="524288"></div>
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input name="state" class="input-field" value="<?php echo $user_info['name']; ?>" placeholder="State" maxlength="524288"></div>
                         ...
                         <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-label">Aadhar DOB</div>

                           <div class="form-field-content">

                              <div class="date-selector">

                                 <div class="date-selector-unit">
                                    <?php $dob =  explode("-", $user_info['dob']); ?>

                                    <input value="<?php echo $dob[0]; ?>" name="day" onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="date-selector-input  js-date-selector-input" placeholder="DD" maxlength="2">

                                    <div class="date-selector-unit-title">Day</div>

                                 </div>

                                 <div class="date-selector-unit">

                                    <input value="<?php echo $dob[1]; ?>" name="month" onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="date-selector-input js-month-selector-input" placeholder="MM" maxlength="2">

                                    <div class="date-selector-unit-title">Month</div>

                                 </div>

                                 <div class="date-selector-unit date-selector--no-border">

                                    <input value="<?php echo $dob[2]; ?>" name="year" onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" class="date-selector-input js-year-selector-input" placeholder="YYYY" maxlength="4">

                                    <div class="date-selector-unit-title">Year</div>
                           ...
                           <div class="form-field-label">Aadhar Image</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input type="file" name="image" class="input-field"></div>
                  ...
                  <div class="my-profile__footer js--my-profile__footer footer_d9dd6">
                     ...
                     <div class="align-center">
                        ...
                        <input class="btn btn--raised btn--white" type="submit" name="" value="Save">
   ...
   <noscript>
      ...
      <style>
         ...
         background-image: url('web_assets/public/imgs/desktop-pwa_2.jpg');
