        ...
        <div class="loginSignup">
          <header class="login_reg_header">
            ...
            <div class="form_title">
                <div class="register_header">REGISTER & PLAY</div>
            </div>
          <section>
            <div class="loginSignupCont">
              
                <div class="signupForm formdiv" >    
                        <div id="success_msg"></div>                
                        <div class="form">
                            <div class="socLogin"><a href="#" class="fb" id="registerform_facebook"><span>Facebook</span></a> <a href="<?php echo $goolge_login_url; ?>" class="go" id="registerform_google"><span>Google</span></a> </div>
                            
                            <div class="or">or</div>
                            <form id="SignupForm" method="POST">
                             <div class="txtField group">
                                <input type="text" onblur="check_referral_code(this.value)" id="referalcode" name="referalcode">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Referral Code</label>
                                <div class="input_description">&nbsp;</div>
                                <label for="regPassword" style="display: none" id="regcodeErr" generated="true" class="errorLabel"></label>
                            </div>  

                            <div class="txtField group">
                                <input type="email/text" onblur="check_email(this.value)" id="regEmail" name="regEmail" required>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Email</label>
                                <div class="input_description">&nbsp;</div>
                                <label for="regEmail" style="display: none" id="regEmailErr"  generated="true" class="errorLabel"></label>
                            </div>
                            <div class="txtField group">
                                <input maxlength="10" onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text" onblur="check_mobile(this.value)"  id="regMobile" name="regMobile" required>
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>Mobile</label>
                                <div class="input_description">&nbsp;</div>
                                <label for="regPassword" style="display: none" id="regmobileErr" generated="true" class="errorLabel"></label>
                            </div>
                            <div class="txtField group">
                                ...
                                <div class="input_description">&nbsp;</div>
                                <label for="regPassword" style="display: none" id="regPassErr" generated="true" class="errorLabel">You gotta enter a password!</label>
                            </div>
                                                     
                            <div class="actBtn"> <a id="regUser" onclick="registration()" name="loginsubmit" class="blueBtn" href="javascript:;">Register</a> </div>
                            <div class="tnc_agreed">
                            By registering, I agree to UAB League <a href="<?php echo base_url('website/termsandcondition')?>" target="_blank">T&Cs</a>
                            </div>
                        ...
                        <div class="login_invite">
                            ...
                            <div class="login_link_box">
                                <div class="title_box">Already a user?</div>
                                <a class="link_box" id="login_jump" href="<?php echo base_url('website/login'); ?>">Log In</a>
                            </div>
                        </div>
...
<div style="display:none"><div class="genericPopup forgotPassword" id='forgotPasswordPopup'><div class="popupTitle">Forgot Password. <span class="popupClose d_closePopup">X</span></div><div class="popupInner"><div class="txtField group"><input type="email/text" id='ForgotFormEmail' name="ForgotFormEmail" required><span class="highlight"></span><span class="bar"></span><label>Email</label><div class="input_description" style="visibility: hidden;">No spam, we promise!</div><label for="ForgotFormEmail" style="display:none" id="forgotPassErr" generated="true" class="errorLabel">Please enter valid email address</label></div><div class="actBtn"><a href="javascript:;" id='ForgotFormSubmit' class="blueBtn">Send Reset Link</a></div></div></div></div>

<div style="display:none">
    <div class="genericPopup" id='socialReminderPop'>
        <div class="popupTitle">Forgot Password?<span class="popupClose d_closePopup">X</span>
        </div>
...
<script type="text/javascript">
    ...
    {       
        ...
        $.ajax({
            type : 'post',       
            url: SITE_URL+'website/reg',
            data : { code:code, password:password ,email:email , mobile:mobile},
            success : function(data) {
                var response = JSON.parse(data);
