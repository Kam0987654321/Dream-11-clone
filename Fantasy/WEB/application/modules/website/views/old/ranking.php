...
@media screen and (min-width: 1200px) {
  ...
  .bottom-nav {
    ...
    height: 100%;
      ...
      <style id="app-style">.appContainer_6475d{max-width:550px;height:100%}.appBgImage_fd065{background-image:url(../web_assets/public/imgs/desktop-pwa_2.jpg);position:fixed;left:550px;right:0;background-size:cover;top:0;bottom:0}.loaderContainer_d2930{display:flex;height:100%;align-items:center}.blockLoader_580b6{margin:12px auto}.loaderCircular_00f73{animation:loader-rotate 2s linear infinite}.loaderPath_00e5f{animation:loader-stroke 1.5s ease-in-out infinite;stroke-dasharray:1, 162;stroke-dashoffset:0;stroke-linecap:round;stroke-width:6}.black_7fbc4{stroke:rgba(0, 0, 0, 0.5)}.fadeIn_73e97{animation:fade-in .25s linear}.appHeaderSpacing_cdb56{height:48px}.appToolbar_1ea26{max-width:550px;left:0;top:0;width:100%;position:fixed;box-shadow:0px 1px 4px 0px rgba(0, 0, 0, 0.3);z-index:2}.header_fc30e{height:48px;display:flex;text-align:center;width:100%;justify-content:space-between;align-items:center}.menuList_1b8cf{padding-bottom:55px}.menuLinkIcon_133fd{padding:8px;color:#888}.menuLinkName_e5264{margin:0 8px}.wrapper_cb3ad{max-width:550px;z-index:4;height:55px}.toolbar_f2b24{text-transform:capitalize;text-align:center;height:48px;display:flex}.tab_4e2e6{color:#fff;display:flex;flex-wrap:nowrap;overflow-x:auto;width:100%;max-width:550px;margin:auto;padding:0 8px}.tabItemSelected_765ac{border-bottom:solid 2px #fff !important;opacity:1 !important}.tabItem_66759{align-items:center;display:flex;flex:1 0 auto;height:48px;min-width:80px;justify-content:center;cursor:pointer;transition:all ease-in 300ms;opacity:0.6}.siteTab_56f2f{display:flex;justify-content:center;align-items:center}.siteTabText_ce5fe{text-transform:uppercase}.mainMultisite_b9d32{height:100%;padding-top:49px;overflow:hidden;display:flex;padding-bottom:55px}.homeMainCarousel_3ec17{width:100%}.carouselContainer_cbc2d{position:relative}.carousel_db1fc{overflow:hidden}.carouselContent_4b30b{transition:all 300ms 0ms}.carouselContentStopAnimation_1677b{transition:none;will-change:transform}.homeLists_029e0{display:flex}.homeMain_e36ee{height:100%;width:100%;overflow:scroll;-webkit-overflow-scrolling:touch}.card_690e1{background-color:#fff;margin:8px;box-shadow:0 1px 2px 0 rgba(0, 0, 0, 0.3);border-radius:2px;overflow:hidden}.homeTourContainer_10313{height:100%;width:100%;display:flex;flex-direction:column;align-items:center;color:white;background-color:white;background-size:cover;background-repeat:no-repeat;background-position:center;justify-content:center;max-height:150px}.homeTourName_a86ab{font-size:20px;text-transform:uppercase;margin:4px}.container_bb9c3{text-decoration:none;position:relative;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;}.wrapper_95718{display:flex;align-items:center;flex-direction:column;justify-content:center;position:absolute;top:0;right:0;bottom:0;left:0;height:100%;width:100%;color:white}.loadMoreContainer_4cbac{display:flex;align-items:center;justify-content:center}.iconButton_fe158{background:none;border:0;cursor:pointer;margin:0;text-decoration:none;text-align:center;font-family:inherit;display:flex;justify-content:center;align-items:center;color:inherit;font-weight:500;font-size:14px;height:48px;padding:0 8px;width:48px}.materialIcon_10a4f{font-family:Material Icons;font-weight:normal;font-style:normal;display:inline-block;line-height:1;text-transform:none;letter-spacing:normal;word-wrap:normal;white-space:nowrap;direction:ltr}.empty_eefde{width:48px}</style>
   ...
   <body cz-shortcut-listen="true">
      <div>
         <div class="app-container appContainer_6475d">
            ...
            <div class="lazy-container-global-leaderboard">
               <div class="lazy-global-leaderboard">
                  <div>
                     <div class="global-leaderboard-home">
                        <div class="app-toolbar appToolbar_1ea26">
                           <div class="toolbar_f2b24">
                              <div class="align-center">
                                 <div class="toolbar-title">My Rankings</div>
                              </div>
                           </div>
                           <!-- <div class="tab js--tab tab_4e2e6">
                              <div class="tabItemSelected_765ac tabItem_66759">
                                 <div class="siteTab_56f2f">
                                    <div class="siteTabText_ce5fe">Fixture</div>
                                 </div>
                              </div>
                              <div class="tabItem_66759">
                                 <div class="siteTab_56f2f">
                                    <div class="siteTabText_ce5fe">Live</div>
                                 </div>
                              </div>
                              <div class="tabItem_66759">
                                 <div class="siteTab_56f2f">
                                    <div class="siteTabText_ce5fe">Results</div>
                                 </div>
                              </div>
                           </div> -->
                        </div>
                        <div>
                           <div class="global-leaderboard-home__main--multisite mainMultisite_b9d32">
                              <div class="homeMainCarousel_3ec17">
                                    ...
                                    <div class="bounding-client-rect">
                                       <div class="carousel_db1fc">
                                          <div class="carouselContent_4b30b carouselContentStopAnimation_1677b" style="transform: translateX(0px);">
                                             <div class="homeLists_029e0">
                                                <div class="homeMainCarousel_3ec17">
                                                   <div class="homeMain_e36ee">
                                                      <div class="">
                                                         <div>
                                                            <?php if(count($join_matchs) >0){
                                                            foreach ($join_matchs as $matchs){ ?>
                                                               <div class="card card_690e1">
                                                               <a href="<?php echo base_url('website/leaderboard/'.base64_encode($matchs['match_id']))?>">
                                                                  <div class="container_bb9c3">
                                                                     <div class="lazy-loader lazy-loader--loaded" style="height: 150px;"><img class="lazy-loader__img lazy-loader__img--loaded" src="https://d13ir53smqqeyp.cloudfront.net/mobile/apps/tour_banners/default.jpg"></div>
                                                                     <div class="wrapper_95718">
                                                                        <div class="homeTourName_a86ab"><?php echo $matchs['title']; ?></div>
                                                                     </div>
                                                                  </div>
                                                               </a>
                                                            </div>  
                                                         ...
                                                         <!-- <div class="loadMoreContainer_4cbac">
                                                            <button class="btn btn--bordered">
                                                               <div class="align-center">Load More</div>
                                                            </button>
                                                         </div> -->
                                                      </div>
                                                   </div>
      ...
      <script src="/public/vendors~main-8d24e3a6bc8c08ce4fbd-chunktemp.js"></script><script src="/public/main-17329e71f6ca75b7a6c5-chunktemp.js"></script>
