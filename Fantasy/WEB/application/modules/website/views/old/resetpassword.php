...
.loginSignup .socLogin a.fb span {
    background: url("../../d13ir53smqqeyp.cloudfront.net/d11-static-pages/images/facebook-ico-login.png") no-repeat 0;
    background-size: 21%;
    color: #4460a0;
}
...
.loginSignup .socLogin a.go span {
    background: url("../../d13ir53smqqeyp.cloudfront.net/d11-static-pages/images/google-ico-login.png") no-repeat 0;
    background-size: 24%;
    color: #7b7a7a;
}
        ...
        <div class="loginSignup">
          <header class="login_reg_header">
            ...
            <div class="form_title">
                <div class="login_header" >Reset Password</div>
            </div>
          <section>
                    ...
                    <div class="form">
                        ...
                        <div class="loginFrm">
                            <div class="txtField group">
                                ...
                                <label for="LoginFormEmail" generated="true" id="loginemailError" class="errorLabel"></label>
                                <label for="LoginFormEmail" generated="true" id="email_error" class="errorLabel"></label>
                            ...
                            <div class="txtField group">
                                ...
                                <div class="input_description" >&nbsp;</div>
                                <label for="LoginFormPassword" id="loginPassErr" generated="true" class="errorLabel"></label>
                                
                            </div>
                            <div class="actBtn"><button id="resetpassword_btnss" class="blueBtn" type="button">Change Password</button></div>
                        </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript" src="<?php echo base_url('web_assets/javascripts/resetpassword.js')?>"></script>