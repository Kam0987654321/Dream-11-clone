                  ...
                  <div>
                     ...
                     <div class="app-toolbar appToolbar_1ea26">
                        <div class="js--app-header header_fc30e">
                           <div class="toolbar-title">Me</div>
                           <div></div>
                        </div>
                     </div>
                  </div>
                  <div>
                     <div class="menu__list menuList_1b8cf">
                        <div>
                           <a class="menu__link " href="<?php echo base_url('website/my_matches')?>" target="">
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">star</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">My Matches</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
                           <a class="menu__link " href="<?php echo base_url('website/my_account')?>" target="">
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">account_balance_wallet</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">My Account</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
                           <a class="menu__link " href="<?php echo base_url('website/changePassword')?>" target="">
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">account_balance_wallet</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">Change Password</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
                          <!--  <a class="menu__link " href="<?php //echo base_url('website/invite') ?>" target="">
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">people</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">Invite Friends</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a> -->
                           <a class="menu__link " href="<?php echo base_url('website/ranking')?>" >
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">poll</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">My Rankings</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
                           <a class="menu__link " href="<?php echo base_url('website/personaldetails')?>" >
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">contacts</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">Personal Details</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
                           <a class="menu__link " href="<?php echo base_url('website/transaction')?>" >
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">account_balance</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">Transactions</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
                           <a class="menu__link " href="<?php echo base_url('website/withdrawl')?>">
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">assignment_returned</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">Withdrawal</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
                           <a class="menu__link js--logout-btn" href="<?php echo base_url('website/logout');?>">
                              <div class="link-row__list-row">
                                 <div class="link-row__list-col--img">
                                    <div class="menuLinkIcon_133fd"><i class="material-icons">exit_to_app</i></div>
                                 </div>
                                 <div class="link-row__list-col--wide">
                                    <div class="menuLinkName_e5264">Log Out</div>
                                 </div>
                                 <div class="link-row__navigation-icon"><i class="material-icons">keyboard_arrow_right</i></div>
                              </div>
                           </a>
