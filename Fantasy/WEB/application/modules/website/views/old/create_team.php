                                 ...
                                 <div class="container_aa549">
                                    ...
                                    <div class="progressContainer_00657">
                                       ...
                                       <div class="stepperContainer_b9ae4">
                                          ...
                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block1"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block2"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block3"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block4"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block5"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block6"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block7"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block8"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block9"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block10"></div>

                                          <div class="stepperBlock_8b62f inactiveStepper_4d390" id="block11"><span class="lastStepper_2bce1" >11</span></div>
                                       ...
                                       <div class="playerCardInfoCell_ba412 playerCardInfoContainer_d41f9">
                                          ...
                                          <div class="bold playerCardIconContainer_65be8">
                                            <?php
                                             ...
                                             ?>
                                             <div  class="playerCardIcon_b8a19 "><i class="materialIcon_10a4f keeper_id" style="height: 24px; width: 24px; font-size: 24px;" id="AddBtn_<?php echo $keeper['playerid']; ?>" onclick="checkplayercount(); addPlayer('<?php echo $plyName; ?>' ,<?php echo $keeper['playerid'] ;?>,'<?php echo $wk; ?>',<?php  echo $keeper['credit_points'];?>,'<?php echo $TeamShortName ;?>','<?php echo $image ?>')">add</i>
                                             	<i class="materialIcon_10a4f" style="height: 24px; width: 24px; font-size: 24px; display: none;" onclick="removePlyFromList(1,<?php echo $keeper['playerid']; ?>,<?php echo $keeper['credit_points'];?>,'<?php echo $TeamShortName; ?>');"  id="RemoveBtn_<?php echo $keeper['playerid']; ?>" >remove</i>
                             ...
                             <div class="js--create-team__team-selector__player-card playerCard_42b9d "  id="bwlbg_<?php  echo $bowl['playerid'];?>">
                                       ...
                                       <div class="playerCardInfoCell_ba412 playerCardInfoContainer_d41f9">
                                          ...
                                          <div class="bold playerCardIconContainer_65be8">
                                             ...
                                             ?>
                                              <div class="playerCardIcon_b8a19 "><i class="materialIcon_10a4f" style="height: 24px; width: 24px; font-size: 24px;" id="AddBtn_<?php echo $bowl['playerid']; ?>" onclick="checkplayercount(); addPlayer('<?php echo $plyName; ?>' ,<?php echo $bowl['playerid'] ;?>,'<?php echo $ar; ?>',<?php  echo $bowl['credit_points'];?>,'<?php echo $TeamShortName ;?>','<?php echo $image; ?>')">add</i>
                             ...
                             <div class="js--create-team__team-selector__player-card playerCard_42b9d "  id="batbg_<?php  echo $bats['playerid'];?>">
                                       ...
                                       <div class="playerCardInfoCell_ba412 playerCardInfoContainer_d41f9">
                                          ...
                                          <div class="bold playerCardIconContainer_65be8">
                                             ...
                                             ?>
                                              <div class="playerCardIcon_b8a19 "><i class="materialIcon_10a4f" style="height: 24px; width: 24px; font-size: 24px;" id="AddBtn_<?php echo $bats['playerid']; ?>" onclick="checkplayercount(); addPlayer('<?php echo $plyName; ?>' ,<?php echo $bats['playerid'] ;?>,'<?php echo $bat; ?>',<?php  echo $bats['credit_points'];?>,'<?php echo $TeamShortName ;?>','<?php echo $image; ?>')">add</i>
