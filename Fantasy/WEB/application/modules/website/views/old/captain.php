<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <!--PRELOAD-->
  <link rel="preload" as="style" href="./captain_files/montserrat-400,500,600-v2.css">
              ...
              <div class="teamPreviewRowWrapper_0c54c">
                ...
                <div class="spaceAround_64779 rowContent_8aa5f">
                  ...
                  <div class="spaceAround_64779 rowContent_8aa5f">
                    <div class="js--field-player fieldPlayerMain_32975">
                      <div>
                        <div class="playerImageProfile_0cc1f">
                          ...
                          <div class="fieldPlayerTitle_4ac32" style="<?php echo $style; ?>"><?php echo $batm['name']; ?></div><div class="playerPoints_d4e06"><?php echo $batm['credit_points']; ?>  Cr</div>
                        </div>
                      </div>
                       <?php 
                  } ?>
                    ...
                    <div class="fieldPlayerTitle_4ac32" style="<?php echo $style; ?>"><?php echo $all['name']; ?></div><div class="playerPoints_d4e06"><?php echo $all['credit_points']; ?>  Cr</div>
                  </div>
                </div> 
                 <?php 
                      } ?> 
                    ...
                    <div class="playerCardInfoCell_ba412 playerCardInfoContainer_d41f9">
                      ...
                      <div class="rolesContainer_7991a">
                       ...
                       <form method="post" action="<?php echo base_url('website/update_team'); ?>">
                        ...
                        <div class="footer_d9cd3"><div class="footerButtonContainer_b9ae4"><div class="js--create-team_save"><button disabled="disabled" id="sub_save" type="submit" class="new-button disabledButton_cf79e raisedGreenButton_20c05 raisedGreenButtonDisabled_e0a23">SAVE TEAM</button></div></div></div></div></div></div></div></div></div><div></div><div></div><div></div></div></div></div></div></div></div>
