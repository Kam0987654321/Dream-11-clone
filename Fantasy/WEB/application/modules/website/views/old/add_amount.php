                  ...
                  <div>
                     ...
                     <div class="app-toolbar appToolbar_1ea26">
                        ...
                        <div class="js--app-header header_fc30e">
                           ...
                           <div class="toolbar-title">Add Amount</div>
                     ...
                     <div id=""> <?php if($this->session->flashdata('error')){echo $this->session->flashdata('error'); } ?> </div>

                  </div>

                  <form id="request" method="post" action="<?php echo base_url('website/request_amount'); ?>" >
                     ...
                     <div>
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="amount" id="amount" value="" class="input-field"  placeholder="Amount"></div> 
                     ...
                     <div>
                        <div class="form-field padding_b8f9b formField_4712e">
                           <div class="form-field-content">
                              <div class="input-field-container ">
                                    ...
                                    <div class="ratio-box" style="border:1px; background:; padding:5px 2px; border-radius:5px; width: 12%; text-align: center; border:2px solid #000; margin:10px 50px;">
                              
                                        <span style="float:left; padding:8px; margin-left:1%;">&#8377</span><input type="button" onclick="get_value(this.value)" value= "50" name="check"  class="btn btn-lg btn-danger"  style="float:left; padding:0px; margin-top:3px;">
                                        
                                    </div>
                                    
                                     <div class="ratio-box" style="border:1px; background:; padding:5px 2px; border-radius:5px; width: 12%; text-align: center; border:2px solid #000; margin:10px 50px;">
                              
                                        <span style="float:left; padding:8px; margin-left:1%;">&#8377</span><input type="button" onclick="get_value(this.value)" value= "100" name="check"  class="btn btn-lg btn-danger"  style="float:left; padding:0px; margin-top:3px;">
                                        
                                    </div>
                                    
                                    <div class="ratio-box" style="border:1px; background:; padding:5px 2px; border-radius:5px; width: 12%; text-align: center; border:2px solid #000; margin:10px 50px;">
                              
                                        <span style="float:left; padding:8px; margin-left:1%;">&#8377</span><input type="button" onclick="get_value(this.value)" value= "500" name="check"  class="btn btn-lg btn-danger"  style="float:left; padding:0px; margin-top:3px;">
                                        
                                    </div>
                                    
                          
                                  <!---
                                 <input type="radio" onclick="get_value(this.value)" value="50" name="check"  class="input-field"  > 50 
                                 <input type="radio" onclick="get_value(this.value)" value="100" name="check"  class="input-field"  > 100
                                 <input type="radio" onclick="get_value(this.value)" value="500" name="check"  class="input-field"  > 500
                        ...
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input type="text" name="name" id="name" value="" class="input-field" value="<?php echo $user_info['name'];?>" required   placeholder="Name"></div> 
                        ...
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input type="text" name="email" id="email" value="<?php echo $user_info['email'];?>"  class="input-field"  placeholder="Email"></div> 
                        ...
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-label">Number</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input maxlength="10" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="number" id="number" value="<?php echo $user_info['mobile'];?>" class="input-field"  placeholder="Number"></div> 
