...
---------->
 ...
 <!--  <link href="https://d13ir53smqqeyp.cloudfront.net/contain/marketing/landing_pages/favicon.ico" rel="shortcut icon"/> -->
  ...
  <div>
    ...
    <header class="header-settings">
      <div class="container" style="padding:0px;">
        ...
        <div class="cross"></div>
        <a class="logo logo-desktop" href="<?php echo base_url('website/index'); ?>"><img height="100px" width="100px" alt="logo" src="<?php echo base_url('web_assets/image/logo.png');?> "></a>
        <!---Desktop navbar---->
        ...
        <nav style="padding: 10px; width:100%" class="mobi-nav menu navbar navbar-expand-lg ">
          <div class="col-sm-6 col-xs-6">
           <a class="logo-hide" href="<?php echo base_url('website/leagues'); ?>"><img style="float:left; height:50px; width:50px;" src="<?php echo base_url('web_assets/image/logo.png');?>"></a>
         </div>
         <div class="col-sm-6 col-xs-6">
