         ...
         <div class="lazy-container-my-profile">
            ...
            <div class="lazy-my-profile">
               ...
               <div class="my-profile">
                  ...
                  <div>
                     ...
                     <div class="app-toolbar appToolbar_1ea26">
                        ...
                        <div class="js--app-header header_fc30e">
                           ...
                           <div class="toolbar-title">UPLOAD PANCARD</div>
                  ...
                  <form method="post" enctype="multipart/form-data" action="<?php echo base_url('website/update_pan_information');?>">

                  <div class="my-profile__container">
                     <div>
                        <div class="form-field padding_b8f9b formField_4712e">

                           <div class="form-field-label">Pan card Name</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input name="pan_card_name" class="input-field" value="<?php echo $user_info['name']; ?>" placeholder="Full Name" maxlength="524288"></div>
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input name="pan_number" class="input-field" value="<?php echo $user_info['name']; ?>" placeholder="Pan Number" maxlength="524288"></div>
                         ...
                         <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-label">Pan DOB</div>
                           ...
                           <div class="form-field-label">Pan Image</div>
