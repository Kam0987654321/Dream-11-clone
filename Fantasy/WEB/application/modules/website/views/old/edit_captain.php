...
<style type="text/css">.roleSelected_961ad {background-color: #000; color: #fff;}.fb_hidden{position:absolute;top:-10000px;z-index:10001}.fb_reposition{overflow:hidden;position:relative}.fb_invisible{display:none}.fb_reset{background:none;border:0;border-spacing:0;color:#000;cursor:auto;direction:ltr;font-family:"lucida grande", tahoma, verdana, arial, sans-serif;font-size:11px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:1;margin:0;overflow:visible;padding:0;text-align:left;text-decoration:none;text-indent:0;text-shadow:none;text-transform:none;visibility:visible;white-space:normal;word-spacing:normal}.fb_reset>div{overflow:hidden}@keyframes fb_transform{from{opacity:0;transform:scale(.95)}to{opacity:1;transform:scale(1)}}.fb_animate{animation:fb_transform .3s forwards}
                ...
                <div>
                  <div class="spaceAround_64779 tall_56497">
                    <div class="teamPreviewRowWrapper_0c54c">
                      ...
                      <div class="fieldPlayerTitle_4ac32" style="background-color: rgb(196, 63, 45);"><?php echo $keep['name'];?></div>
              ...
              <div class="teamPreviewRowWrapper_0c54c">
                ...
                <div class="spaceAround_64779 rowContent_8aa5f">
                  ...
                  <div class="spaceAround_64779 rowContent_8aa5f">
                    <div class="js--field-player fieldPlayerMain_32975">
                      <div>
                        <div class="playerImageProfile_0cc1f">
                          ...
                          <div class="fieldPlayerTitle_4ac32" style="background-color: rgb(55, 89, 165);"><?php echo $batm['name']; ?></div><div class="playerPoints_d4e06"><?php echo $batm['credit_points']; ?>  Cr</div>
                        </div>
                      </div>
                       <?php 
                  } ?>                    
                        ...
                        <div class="teamPreviewRowWrapper_0c54c"><div class="rowTitle_b91f3">All-Rounders</div>
                    ...
                    <div class="fieldPlayerTitle_4ac32" style="background-color: rgb(55, 89, 165);"><?php echo $all['name']; ?></div><div class="playerPoints_d4e06"><?php echo $all['credit_points']; ?>  Cr</div>
                  </div>
                </div> 
                 <?php 
                      } ?> 
                        ...
                        <div class="spaceAround_64779 rowContent_8aa5f">
                          ...
                          <div class="fieldPlayerTitle_4ac32" style="background-color: rgb(55, 89, 165);"><?php echo $bal['name']; ?></div>
                        ...
                        <div class="headerContainer_1725f"><div class="defaultHeaderContent_00a63"><div class="headerLeft_36c4e"><button class="btn btn--icon"><div class="align-center"><i class="material-icons">keyboard_arrow_left</i></div></button></div><div class="headerCenter_4d6f0"><span><div class="timer_3d48d"><!-- 17h left --></div></span></div><div class="headerRight_d1c5d"></div></div></div><div><div class=""><div class="eePage_1602f"><div class=""><div class="create-team-role-selector roleSelector_d9dd6"><div class="content_5e15a"><div class="titleBox_a1dab titleBoxWebkit_3d076"><div><div class="bold"><span>Choose</span><span class="rolesTitle_48372"> your Captain &amp; Vice Captain</span></div><div class="create-team-role-selector__subtitle"><div class="subtitleContainer_b9ae4"><div class="roleSubtitle_62c2d"><div class="roleIcon_f75d0">C</div><div class="roleMultiplierText_07275"> gets 2X Points</div></div><div class="roleSubtitle_62c2d"><div class="roleIcon_f75d0">VC</div><div class="roleMultiplierText_07275"> gets 1.5X Points</div></div></div></div></div></div><div><div><div class="sortingHeader_580ae"><div class="playerCardCell_bf9d8 playerCardAvatarCell_4541e"></div><div class="playerCardInfoCell_ba412"><div class="playerCardCell_bf9d8 playerCardNameCell_50086"><span>PLAYERS</span></div><div class="playerCardCell_bf9d8 playerPointsCell_aa0e3 activeSortKey_c7202"><span>POINTS<span><i class="materialIcon_10a4f" style="height: 10px; width: 10px; font-size: 10px;">arrow_downward</i></span></span></div><div class="rolesContainer_7991a"></div></div></div></div>
                       <?php foreach ($players as $player) {
                         ?>
                          ...
                          <div class="imageContainer_029e0">
                            ...
                            <div class="playerImage_f320d" style="background-image: url('<?php echo base_url('uploads/player/'.$player['image']); ?>');">
                    ...
                    <div class="playerCardInfoCell_ba412 playerCardInfoContainer_d41f9">
                        ...
                        <div>
                        <div class="playerName_73cad"><?php echo $player['name']; ?></div>
                        <div class="playerTeamTitle_a2024"><span><?php echo $player['team_short_name']; ?></span>
                          <span class="light">- <?php echo $player['short_term']; ?></span>
                        </div>
                      </div>
                      </div><div class="playerCardCell_bf9d8 playerPointsCell_aa0e3"><?php echo $player['credit_points']; ?></div>
                      <div class="rolesContainer_7991a">
                        <div class="create-team__role-selector__button-element js--create-team__role-selector__button-element">
                          <div>
                          <div  id="cap_<?php echo $player['player_id'];?>" onclick="check(); get_captain('<?php echo $player['player_id'];?>')" class="captains_role roleIcon_b2caf">C</div>
                        </div>
                        </div>
                          <div class="create-team__role-selector__button-element js--create-team__role-selector__button-element">
                            <div>
                              <div id="vice_<?php echo $player['player_id'];?>" onclick="check(); get_vicecaptain('<?php echo $player['player_id'];?>')" class="vicecaptains_role roleIcon_b2caf">VC</div>
                          </div>
                        </div>
                        </div>
                      </div>
                       ...
                       <form method="post" action="<?php echo base_url('website/update_team_players'); ?>">
                         <input type="hidden" id="captain_id" name="captain" value="">
                         <input type="hidden" id="vicecaptain_id" name="vicecaptain" value="">
                         <input type="hidden" id="team_id" name="team_id" value="<?php echo $this->uri->segment('3'); ?>">
                        <div class="footer_d9cd3"><div class="footerButtonContainer_b9ae4"><div class="js--create-team_save"><button id="sub_save" class="new-button disabledButton_cf79e raisedGreenButton_20c05 raisedGreenButtonDisabled_e0a23">SAVE TEAM</button></div></div></div></div></div></div></div></div></div><div></div><div></div><div></div></div></div></div></div></div></div></form>
<noscript>
  <style>
    #app {
      display: none;
...
<script type="text/javascript">
 function get_captain(id)
  {
    var id = id;
    $('.captains_role').removeClass("roleSelected_961ad");
    $("#cap_"+id).addClass("roleSelected_961ad");
    
    $('#captain_id').val(id);

    var vicecaptain = $('#vicecaptain_id').val();

    if(id == vicecaptain)
    {
    	alert('Please Select other player');
    	$('.captains_role').removeClass("roleSelected_961ad");
    	$('#captain_id').val('');
    	$('#sub_save').addClass('disabledButton_cf79e raisedGreenButtonDisabled_e0a23');
    	$(":submit").attr("disabled", true);
    }
    else if(vicecaptain =="" || id =="")
    {
      $('#sub_save').addClass('disabledButton_cf79e raisedGreenButtonDisabled_e0a23');
      $(":submit").attr("disabled", true);
    }	
  ...
  function get_vicecaptain(id)
  {
    var id = id;
    $('.vicecaptains_role').removeClass("roleSelected_961ad");
    $("#vice_"+id).addClass("roleSelected_961ad");
    $('#vicecaptain_id').val(id);

    var captain = $('#captain_id').val();
    if(id == captain)
    {
    	alert('Please Select other player');
    	$('.vicecaptains_role').removeClass("roleSelected_961ad");
 ...
 function check(){
    ...
    {
      $('#sub_save').removeClass('disabledButton_cf79e raisedGreenButtonDisabled_e0a23');
