               ...
               <div class="my-profile">
                  ...
                  <div>
                     ...
                     <div class="app-toolbar appToolbar_1ea26">
                        ...
                        <div class="js--app-header header_fc30e">
                           ...
                           <div class="toolbar-title">Withdraw Request</div>
                  ...
                  <div class="my-profile__container">
                     ...
                     <div>
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-label">Amount</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input type="text" name="amount" id="amount" class="input-field"  placeholder="Amount"></div> 
                        ...
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-label">User Account Name</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input type="text" name="user_acc_name" id="user_acc_name" value="<?php echo  $user_info['user_acc_name']; ?>" class="input-field"  placeholder="User Account  Name"></div>
                              <div id="user_acc_name_error"></div>
                        ...
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input type="text" name="acc_no" id="acc_no" class="input-field" value="<?php echo $user_info['acc_no']; ?>" placeholder="Account Number"></div> 
                              <div id="acc_no_error"></div>
                        ...
                        <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input name="bank_name" id="bank_name" type="text" value="<?php echo $user_info['bank_name'] ?>"  class="input-field"  placeholder="Bank Name" ></div> 
                         ...
                         <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input name="ifsc_code" id="ifsc_code" value="<?php echo $user_info['ifsc_code'] ?>"  type="text" class="input-field"  placeholder="IFSC Code" ></div> 
                         ...
                         <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-label">Branch Address</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input name="branch_address" id="branch_address" type="text" class="input-field"  value="<?php echo $user_info['branch_address'] ?>"  placeholder="Branch Address" ></div>
                              <div id="branch_address_error"></div>
                         ...
                         <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-label">User Mobile Number</div>

                           <div class="form-field-content">

                              <div class="input-field-container"><input name="user_mobile" id="user_mobile" type="text" class="input-field"  placeholder="User Mobile Number" value="<?php echo $user_info['user_mobile'] ?>" ></div>
                              <div id="user_mobile_error"></div>
                         ...
                         <div class="form-field padding_b8f9b formField_4712e">
                           ...
                           <div class="form-field-content">
                              ...
                              <div class="input-field-container"><input name="pan_number" id="pan_number" type="text" class="input-field"  placeholder="Pan Number" value="<?php echo $user_info['pan_number'] ?>" ></div>
                              <div id="pan_number_error"></div>
                         ...
                         <div class="form-field padding_b8f9b formField_4712e">
                           <div class="form-field-label">Aadhar Number</div>
                           <div class="form-field-content">
                              <div class="input-field-container"><input name="aadhar" id="aadhar" type="text" class="input-field"  placeholder="Aadhar Number" value="<?php echo $user_info['aadhar'] ?>" ></div>
                  ...
                  <div class="my-profile__footer js--my-profile__footer footer_d9dd6">
                     <div class="align-center">
                        <button type="button" onclick="request()"  class="btn btn--raised btn--white">
                           <div  class="align-center">SAVE</div>
                        </button>
...
<script type="text/javascript">
  function request() {   
    ...
    if(amount == "")
    {
       $("#amount_error").css("display", "block").css("color", "#de4d3b");
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                if(response.status == '1')
                {
                 ...
                 window.location = SITE_URL+ 'website/withdrawl';
             }, 2000 );
