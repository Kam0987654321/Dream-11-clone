<div class="content-wrapper">
    ...
    <section class="content">
	 <div class="box box-default">
        ...
        $contest = $this->Default_contest_model->get_by_id($contest_id);

        echo $contest->contest_name; ?></td></tr>
        <tr><td>Rank</td><td><?php echo $rank; ?></td></tr>
        <tr><td>price</td><td><?php echo $price; ?></td></tr>
        <tr><td></td><td><a href="<?php echo site_url('default_contest/winning_information/'.$contest->contest_id) ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
	</div>
	</div>
	</section>
