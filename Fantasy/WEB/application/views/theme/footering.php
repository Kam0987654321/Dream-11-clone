...
<script defer="" src="<?php echo base_url('institute_assets/theme/lazyload.min.js');?>"></script>
...
<script src="<?php echo base_url('institute_assets/theme/angular.min.js');?>" type="text/javascript"></script>
<script src="<?php echo base_url('institute_assets/theme/bootbox.min.js');?>" type="text/javascript"></script>
 <script src="<?php echo base_url('assets/js/plugins/datapicker/bootstrap-datepicker.js');?>"></script>

<script src="<?php echo base_url('institute_assets/theme/bootstrap.min.js');?>"></script>

<script src="<?php echo base_url('institute_assets/theme/checkout.js');?>"></script>
...
<!--<script src="<?php echo base_url('institute_assets/theme/mocktest-concat.a094e2e2edfe6e8abd0803386984a781.js')?>"></script>-->

<script src="<?php echo base_url('institute_assets/theme/tb-sdk.59ff4676295250001bc818f3c1bffab0.js');?>"></script>
<script>
