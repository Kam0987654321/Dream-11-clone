                     ...
                     <div class="row">
                        ...
                        <div class="col-xs-12 tests-sections ng-scope" ng-repeat="categoryObj in myTestsArr" ng-show="showCategoryForMyTests(categoryObj.value)">
                           ...
                           <div class="body">
                              <div class="row">
                              	 <div class="col-xs-12 packs-container">
                                 <?php if(isset($student_testseries))
                              	{ 
                              		foreach($student_testseries as $student)
                                    {		

                                       $StudentId=$this->session->userdata('StudentId');
                                      echo  $TestId=$student->TestseriesId;
                                       $testseries_count=$this->testseries_model->testseries_paper_count($TestId);
                              	 ...
                              	 ?>
                                    ...
                                    <div class="mt-card my-test-card ng-scope fst-test-card nt-default-state has-syll-info has-tags test-resumable" data-tid="5a464d1282b5d90f7816579b" ng-class="test.myCardClass" ng-repeat="test in categoryObj.value" ng-if="filterTest(test, &#39;myTests&#39;)">
                                       <div class="title">
                                          <h4 title="Syndicate Bank PO Full Test" class="ng-binding"><?php echo $student->TestseriesTitle ; ?></h4>
                                       </div>
                                       <div class="tags">
                                          <!-- ngRepeat: x in test.specificExams track by $index --><span ng-repeat="x in test.specificExams track by $index" class="ng-binding ng-scope"><?php echo $student->TestseriesTitle ; ?></span><!-- end ngRepeat: x in test.specificExams track by $index -->
                                       </div>
                                       <div class="hidden-subs-expired">
                                          <div class="date-time valid-till">
                                             Assign On: <span class="ng-binding"><?php echo date('d M Y',strtotime($student->AssignDate)); ?></span>
                                          </div>
                                       ...
                                       <div class="start-test">
                                          <a href="<?php echo site_url('Testseries/show_testpapers/'.$student->TestseriesId); ?>" class="btn btn-block btn-theme"  >Start Exam</a>
