...
function  get_practice_test(catid){
  ...
  $.post(SITE_URL+'/institute_admin/questions/get_practice_test_id'  ,{
    catid:catid
...
function  get_quiz_test(catid){
  ...
  $.post(SITE_URL+'/institute_admin/questions/get_quiz_test_id'  ,{
    catid:catid
...
function get_exam_test(examid){
  $.post(SITE_URL+'/institute_admin/questions/get_exam_test_by_examid',{
        examid:examid
    },function(responsedata,status){
      var response = JSON.parse(responsedata);
      if(response.status == '1')
...
if(validate==0){
    ...
    e.preventDefault();
    $.ajax({
            url: SITE_URL+'/institute_admin/questions/save_questions', // Url to which the request is send
...
if(validate==0){
    ...
    e.preventDefault();
    $.ajax({
            url: SITE_URL+'/institute_admin/questions/save_subject', // Url to which the request is send
            type: "POST", // Type of request to be send, called as method
            data: new FormData(this), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false, // The content type used when sending data to the server.
            cache: false, // To unable request pages to be cached
...
{
    $.ajax({
            url: SITE_URL+'/institute_admin/questions/UploadExcelRead', // Url to which the request is send
            type: "POST", // Type of request to be send, called as method
...
{
  $.post(SITE_URL+'/institute_admin/questions/get_subject_module_list',
  {
      subjectid:subjectid
  },
    function(responsedata,status){
...
if(validate==0){
    ...
    e.preventDefault();
    $.ajax({
            url: SITE_URL+'/institute_admin/questions/save_practice_questions', // Url to which the request is send
            type: "POST", // Type of request to be send, called as method
            data: new FormData(this), // Data sent to server, a set of key/value pairs (i.e. form fields and values)
            contentType: false, // The content type used when sending data to the server.
            cache: false, // To unable request pages to be cached
...
function  get_exam_questions(catid){
  ...
  $.post(SITE_URL+'/institute_admin/questions/get_questions_list_by_id'  ,{
    catid:catid
